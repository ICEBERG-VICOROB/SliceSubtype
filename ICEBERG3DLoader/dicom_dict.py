#Hint to separate with spaces:
#import re
#Import re.sub(r"(\w)([A-Z])", r"\1 \2", dicom_dict[key])
#Source: https://exiftool.org/TagNames/DICOM.html

#Some tags are still missing
dicom_dict = {
...
"0028|0303":"LongitudinalTemporalInformationModified", #Added
